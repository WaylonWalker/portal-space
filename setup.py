"""
portal_space uses setup tools for packaging.

To Build portal_space as a Python package
...
setup(
    ...
    url="https://github.com/waylonwalker/portal_space",
    ...
    entry_points={
        "console_scripts": ["portal-space = portal_space.cli.__init__:portal_space"],
    },
)
